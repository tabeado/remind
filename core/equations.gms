...
*' Calculation of cumulative emission variables
q_EmiCumNet(ttot,regi)$( 2020 lt ttot.val )..
vm_EmiCum(ttot, regi)
  =e= sum(ttot2$( 2020 le ttot2.val AND ttot2.val le ttot.val ),
      vm_emiAll(ttot2,regi,"co2")
