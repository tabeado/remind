...
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrHeat","seel") = -0.046;
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrHeat","sehe") = 1.025; 
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrElec","seel") = 0.354; 
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrCHP","sehe") = 0.258; 
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrCHP","seel") = 0.313; 
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrCHP850","sehe") = 0.4; 
p04_prodCoupleGlob("pebiolc","sebiochar","biopyrCHP850","seel") = 0.452; 
