...
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","seel") = -0.27; !! from Fraunhofer UMSICHT data
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","seliqbio") = 0.36; !! from Fraunhofer UMSICHT data
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","segabio") = 1.5; !! from Fraunhofer UMSICHT data (net yield including self-sustenance gas requirement - originally propane is used)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharMedBCTech","segabio") = 0.31; !! from Schmidt et al 2019 & Roberts et al 2010 (net yield including self-sustenance gas requirement)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharMedGasTech","segabio") = 1.22; !! from Schmidt et al 2019 & Roberts et al 2010 (net yield including self-sustenance gas requirement)
