...
p04_prodCoupleGlob("pebiolc","sebiochar","biocharElec","seel") = 0.09; !! from Fawzy et al (2022)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHeat","seel") = -0.007; !! from Fawzy et al (2022)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHeat","sehe") = 0.47; !! from Fawzy et al (2022)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharOnly","seel") = -0.007; !! from Fawzy et al (2022)
...
p04_prodCoupleGlob("cco2","ico2","ccsinje","seel")          = -0.005; !! Unit: TWa/GtC ; see q32_balSE for use
