...
p21_taxrevCDR0(ttot,all_regi)                                       "reference level value of subsidy for CDR in case it is separate from CO2 price"
...
p21_taxrevCDR_iter(iteration,ttot,all_regi)                         "track reference level value of tax which reduces CDR revenues as fraction of CO2 price"
...
q21_taxrevCDR(ttot,all_regi)                                        "calculation of CDR revenues"
